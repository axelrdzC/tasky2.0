    ...
    <div class="layout overflow-hidden">
        ...
        <div class="border-r border-indigo-500 bg-white text-white w-72 h-full overflow-hidden p-6 flex flex-col justify-between shadow-xl">
            <div>
                        ...
                        @foreach ($espacios as $espacio)
                            ...
                            <div id="actions-{{ $espacio->id }}" class="hidden flex gap-2 mt-2">
                                ...
                                <form action="{{ route('espaciopersonal.edit', $espacio->id) }}" method="GET" class="w-full">
                                    <button type="submit"
                                            class="flex items-center gap-2 py-2 px-3 bg-yellow-400 text-white rounded-lg hover:bg-yellow-500 w-full transition-all duration-200">
                ...
                <button type="button" class="readable mt-10 bg-indigo-500 text-white py-2 px-4 rounded-lg hover:bg-blue-700 w-full mb-4 transition-all duration-200" onclick="openModal()">
                    + Crear Espacio
                </button>
